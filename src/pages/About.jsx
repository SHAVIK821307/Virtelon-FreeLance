      ...
      <div className="max-w-3xl mx-auto space-y-16">
        ...
        <div className="space-y-4 text-center">
          ...
          <p className="text-gray-200 leading-relaxed">
            ...
            development, digital marketing, and other tech and business-related
            offerings. Our unwavering commitment to excellence, integrity, and
            client satisfaction sets us apart, as we consistently strive to
            exceed expectations and foster long-term partnerships.
          </p>
        </div>
        <hr className="border-white" />
        {/* Mission Section */}
        <div className="space-y-4 text-center">
          ...
          <p className="text-gray-200 leading-relaxed">
            ...
            increasing conversion rates for clients. Our commitment to
            excellence is reflected in our consistent delivery of exceptional
            results, which we measure not only by the projects we complete but
            also by the significant impact we create for our clients.
          </p>
        </div>
        <hr className="border-white" />
        {/* Vision Section */}
        <div className="space-y-4 text-center">
          ...
          <p className="text-gray-200 leading-relaxed">
            ...
            success. Through these strategic alliances, we are dedicated to
            supporting our clients in reaching their goals and consistently
        ...
        <div className="space-y-4 text-center">
          ...
          <p className="text-gray-200 leading-relaxed">
            ...
            client, we gain a deep understanding of their unique goals and
            challenges, allowing us to develop customized solutions that drive
            measurable results.
          </p>
        </div>
      </div>
